...
common = ["아니다.","따라","또는","이는","판시하였다.","있다.","것","수","여기서","여하"]
...
templit = Document("민법총칙법인판례.docx")
...
def Respawn_Problem(Result,Problem_list,NP,NB,LB):
...
Respawn_Problem(Result,Problem_list,1,4,1)                
